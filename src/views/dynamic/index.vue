<template>
    <div class="dynamic-content">
        ...
        <div class="dynamic-upload-image bottom-border-1px">
            ...
            <div class="dynamic-upload-imgs back-repeat" v-for="(img, index) in uplodaImages" :style="{backgroundImage: 'url('+ img.link +')'}" :key="index">
            ...
            <div class="dynamic-upload-imgs back-repeat" v-if="defaultUploadImag"></div>
        </div>
